%********************************************************************
%% gendata2: creates different SDP relaxation to a given POP
%%
%% pop: structure with fields F,G,d,(k),(I),(J),n
%% algotag: specifies relaxation ['SBSOS'|'BSOS'|'SPUT']
%% solvertag: specifies solver ['sdpt3'|'sqlp'|'sedumi'] (optional)
%%
%% Author: Tillmann Weisser
%%********************************************************************

function sdp = gendata2(pop,algotag,solvertag,silent)
if nargin < 3
    convert2solvertag = 0;
else
    convert2solvertag = 1;
